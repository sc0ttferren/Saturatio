...
e.OnInvoke=function() setclipboard('https://discord.gg/G29CmH2RnS') end
game.StarterGui:SetCore('SendNotification',{Title='Saturatio',Text='Thanks for using!',Icon='http://www.roblox.com/asset/?id=8941506186',Duration=5,Button1='discord.gg/XXqzxT7E5z',Callback=e})
local a=''
